...
console.log(datas)
  ...
  return (
    <div>
     ...
     {
      toggle === 'cart'? <div className=" container mx-auto ">
    ...
    {wishList?.map((d) => (
      ...
      <dialog id="my_modal_5" className="modal modal-bottom sm:modal-middle">
        <div className="modal-box">
          ...
          <p className="text-center font-medium textarea-md"> Total Price: $ {totalPrice}</p>
          <div className="modal-action">
            <form method="dialog">
              <button className="text-center flex bg-gray-400 btn">Close</button>
            </form>
          </div>
        </div>
      </dialog>
